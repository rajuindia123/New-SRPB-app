            ...
            <View style={styles.container}>
                <View style={styles.containerTop}>
                    ...
                    <View style={styles.header2}>
                        ...
                        <Text style={styles.subHeaderAddressText}>PURNEA UNIVERSITY, PURNIA</Text>
                ...
                <View style={{ paddingRight: 10 }}>
                    <View style={styles.regAppliForm}>
                        <Text style={styles.regText}>EXAM FORM (CIA)</Text>
                    </View>
                </View>
                ...
                <View style={styles.formContent}>
                    ...
                    <View>
                        <CustomButton buttonStyle={styles.buttonStyle} buttonStyleText={styles.buttonStyleText} children={'Submit & Next'} onClick={() => router.push("/screens/DCCIA/Edit")} />
                    </View>
