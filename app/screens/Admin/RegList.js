...
const RegList = () => {
  ...
  <CustomButton children={"Add Registration"} buttonStyle={styles.buttonStyle} buttonStyleText={styles.buttonStyleText} onClick={()=>router.push('/screens/Admin/AddRegistration')} />
</View>
      </View>
