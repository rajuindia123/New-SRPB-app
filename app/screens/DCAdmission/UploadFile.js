        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.container}>
                <TouchableOpacity style={styles.fileUploadView} onPress={pickDocument}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Matric Result Certificate Pdf </Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.fileUploadView} onPress={pickImage}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Matric Provisional Certificate Pdf</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Inter Provisional Certificate Pdf</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Inter Registration Card Pdf</Text>
                </TouchableOpacity>
                ...
                <View style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Caste Cert</Text>
                </View>
                ...
                <View style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload  Income  Cert</Text>
                </View>
                <View style={styles.fileUploadView}>
                    <View style={styles.ImageSection}>
                        <Image
                    ...
                    <Text style={styles.textStyles}>Click & Upload Residence  Cert</Text>
                </View>
                ...
                <View style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Passport Size Color Photo with name & D.O.B</Text>
                </View>
                ...
                <View style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}> Click & Upload Original CLC</Text>
                </View>
                <View style={styles.fileUploadView}>
                    <View style={styles.ImageSection}>
                        <Image
                    ...
                    <Text style={styles.textStyles}> Click & Upload Original T.C.</Text>
                </View>
                ...
                <View style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}> Click & Upload Original Migration</Text>
                </View>
                ...
                <View style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Univ. Apply Card</Text>
                </View>
                ...
                <View style={styles.fileUploadView}>
                    ...
                    <Text style={styles.textStyles}>Click & Upload Univ. Rank Card</Text>
                </View>
                <View style={{ width: '100%' }}>
                    <CustomButton
                        ...
                        onClick={() => router.push('/screens/SuccessPaymentPage/')}
                    />
                </View>
