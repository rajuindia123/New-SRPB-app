    ...
    <ScrollView style={{ backgroundColor: "#fff" }}>
      <View style={styles.container}>
        ...
        <View style={styles.formContent}>
          ...
          <View>
            <CustomButton buttonStyle={styles.buttonStyle} buttonStyleText={styles.buttonStyleText} children={'Submit & Next'} onClick={() => router.push("/screens/GhosanaPatra/")} />
          </View>
