...
<Text style={[styles.label, { marginTop: 10 }]}>
          ...
          <View>
            <CustomButton buttonStyle={styles.buttonStyle} buttonStyleText={styles.buttonStyleText} children={'Submit & Next'} onClick={() => router.push("/screens/DCCIA/GhosanaPatra")} />
          </View>
